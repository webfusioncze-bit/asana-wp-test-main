          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              {editingField === 'due_date' ? (
                ...
                <p
                  className={`text-xs cursor-pointer hover:bg-gray-50 px-2 py-1.5 rounded transition-colors flex-1 ${
                    task.due_date && new Date(task.due_date) < new Date() ? 'text-red-600 font-medium' : 'text-gray-600'
                  }`}
