...
import { TagIcon, PlusIcon, XIcon, EditIcon, TrashIcon, CheckIcon, SettingsIcon } from 'lucide-react';
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Správa štítků činností</h2>
              </div>
              <button
                onClick={() => {
                  setShowModal(false);
            ...
            <div className="p-6 overflow-y-auto flex-1">
              {!showForm && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm mb-6"
                >
              ...
              {loading ? (
                <div className="text-sm text-gray-500 text-center py-8">Načítání štítků...</div>
              ) : tags.length === 0 ? (
